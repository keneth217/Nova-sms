    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'mpesa',
            name: 'admin-developer-mpesa',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'M-Pesa', docId: 'mpesa' },
          },
          {
            path: 'mpesa/stk',
            name: 'admin-developer-mpesa-stk',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'STK Push', docId: 'mpesa-stk' },
          },
          {
            path: 'mpesa/checkout',
            name: 'admin-developer-mpesa-checkout',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Checkout', docId: 'mpesa-checkout' },
          },
          {
            path: 'mpesa/status',
            name: 'admin-developer-mpesa-status',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Payment status', docId: 'mpesa-status' },
          },
          {
            path: 'mpesa/c2b',
            name: 'admin-developer-mpesa-c2b',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Paybill C2B', docId: 'mpesa-c2b' },
          },
          {
            path: 'mpesa/callbacks',
            name: 'admin-developer-mpesa-callbacks',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Callbacks', docId: 'mpesa-callbacks' },
          },
          {
            path: 'mpesa/authentication',
            name: 'admin-developer-mpesa-authentication',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Authentication', docId: 'authentication' },
          },
          {
            path: 'mpesa/integration/spring-boot',
            name: 'admin-developer-mpesa-spring',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Spring Boot', docId: 'spring-boot' },
          },
          {
            path: 'mpesa/integration/nodejs',
            name: 'admin-developer-mpesa-nodejs',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Node.js', docId: 'nodejs' },
          },
          {
            path: 'mpesa/integration/php',
            name: 'admin-developer-mpesa-php',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'PHP', docId: 'php' },
          },
          {
            path: 'mpesa/integration/python',
            name: 'admin-developer-mpesa-python',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
            meta: { title: 'Python', docId: 'python' },
          },
          {
            path: 'mpesa/integration/generic-http',
            name: 'admin-developer-mpesa-http',
            component: () => import('@/views/admin/developer/DeveloperDocView.vue'),
